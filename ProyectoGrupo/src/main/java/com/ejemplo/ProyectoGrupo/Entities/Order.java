...
public class Order {
	...
	private ArrayList<Order_detail> lista;//--
	...
	public ArrayList<Order_detail> getLista() {
		return lista;
	}

	public void setLista(ArrayList<Order_detail> lista) {
		this.lista = lista;
	}
	...
	public String toString() {
		return "Order [" + (id != null ? "id=" + id + ", " : "")
				...
				+ /*(cliente != null ? "cliente=" + cliente + ", " : "") + */(lista != null ? "lista=" + lista : "") + "]";
	}
